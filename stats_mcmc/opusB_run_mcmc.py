...
_DEFAULT_OBS = [
    ...
    # FIX: Harvey+15 velocity changed 1500 → 1000 km/s (see docstring)
    ("72 cluster mergers", 1000,  0.2,  0.0,  0.47, "Harvey+15"),
    ("TBTF dwarfs",         30,   1.0,  0.5,  5.0,  "Elbert+15"),
]

if cfg.get("observations"):
    OBSERVATIONS = [
        (o["name"], o["v_km_s"], o["central"], o["lo"], o["hi"], o.get("ref", ""))
        for o in cfg["observations"]
    ]
else:
    OBSERVATIONS = _DEFAULT_OBS
