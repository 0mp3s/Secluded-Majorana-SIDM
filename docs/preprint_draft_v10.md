...
**Results.** The MAP benchmark ($\alpha = 5.7 \times 10^{-3}$) produces $r_{\rm core} = 829$ pc, comfortably enclosing all 5 GCs at all deprojection angles: **15/15 safe** (5 GCs \times 3 deprojections). The core size is consistent with the observationally inferred core radius of Fornax ($r_{\rm core} \approx 500$–$900$ pc; Walker & Pe\~narrubia 2011; Amorisco & Evans 2012).
