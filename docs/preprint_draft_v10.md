...
| Section | Observable | BP1 ($\lambda = 1.9$) | BP9 ($\lambda = 4.3$) | MAP ($\lambda = 48.6$) | Observation / Constraint |
|---|---|---|---|---|---|
...
| §7.2 | Fornax $\sigma_{\rm los}$ (Jeans, $\beta=0$) | ✅ $\chi^2=39$ | ⚠ $\chi^2=68$ | ⚠ $\chi^2=48$ | NFW: $\chi^2=152$ (cusp ruled out) |
