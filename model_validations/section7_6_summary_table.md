...
| Section | Observable | BP1 ($m_\chi = 20.7$ GeV, $\lambda = 1.9$) | BP9 ($m_\chi = 37.9$ GeV, $\lambda = 4.3$) | MAP ($m_\chi = 90.6$ GeV, $\lambda = 167$) | Observation / Constraint |
|---|---|---|---|---|---|
...
| §7.5 | Crater II $r_{\rm core}$ | 27 pc | 32 pc | ⚠ 197 pc | $r_{\rm half} = 1066$ pc (tidal+SIDM) |
...
**MAP** ($\lambda = 167$, deep resonant regime) is the **astrophysical champion**:
- Produces observable cores in most dwarf spheroidals (6/8 classical, 5/6 UFDs)
- Achieves perfect Fornax GC survival (15/15)
- Shows true $\sigma/m$ plateau at low velocities (7% variation across $v = 1$–$12$ km/s)
