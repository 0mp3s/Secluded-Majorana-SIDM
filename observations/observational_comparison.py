#!/usr/bin/env python3
"""
V10 — v33_observational_comparison.py
=======================================
Compare our BP1 σ/m(v) curve against REAL observational constraints
extracted from published astrophysical data.

Data sources:
  1. Kaplinghat, Tulin & Yu (2016) PRL 116, 041302 — Table I
     σ/m inferred from halo shape/density analysis of 8 systems
  2. Kamada, Kaplinghat, Pace, Yu (2017) PRL 119, 111102
     Diverse rotation curves require σ/m ~ 1-5 at v~30-50
  3. Bullet Cluster: Randall+ (2008), σ/m < 1.25 cm²/g at v~4700 km/s
     Harvey+ (2015) σ/m < 0.47 cm²/g at v~1000-2000
  4. Abell 3827: Massey+ (2015), possible σ/m ~ 1.5 at v~1500
  5. Elbert+ (2015): dwarf galaxies require σ/m > 0.5 at v~30-50

Output:
  - v33_observational_comparison.png (Figure 3)
  - v33_output.txt (numerical results)
"""
...
if __name__ == '__main__':
    try:
        ...
        notify("\u2705 observational_comparison done!")
    except Exception:
        pass
