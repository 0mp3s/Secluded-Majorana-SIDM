...
| 3 | Coupled Boltzmann $(n_\chi, n_\phi, T_\phi)$ עם cannibal $3\phi \to 2\phi$ | ✅ **PASSED** | Formula corrected per Opus B review: $\langle\sigma v^2\rangle = 25\sqrt{5}/(512\pi(4\pi)^6)\,\mu_3^6/m_\phi^{11}$ [Farina+ 2016]. Overclosure for μ₃/m_φ ≲ 1.3, subdominant (Ω_φ < 0.12) for μ₃/m_φ ≳ 1.7. One-sided bound — no fine-tuning. Ω_χ independent of μ₃. Script: `mixed_coupling/opusA/condition3_cannibal_sensitivity.py` |
